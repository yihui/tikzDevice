...
function (file = ifelse(onefile, "./Rplots.tex", "./Rplot%03d.tex"),
  ...
  bg="transparent", fg="black", pointsize = 10, lwdUnit = 1,
...
\begin{flexlabelled}{code}{*}{0.5em}{0.5em}{*}{\leftmargin}
  ...
  \item[lwdUnit]
    ...
    Default to 72.27/96 (96 pixels in R is 1 inch, which is 72.27 points in
    TeX); previously hardcoded to 0.4 (LaTeX and TikZ default).
